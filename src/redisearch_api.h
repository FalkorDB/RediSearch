...
MODULE_API_FUNC(void, RediSearch_VectorFieldSetM)(RSIndex* sp, RSFieldID fs, size_t m);
MODULE_API_FUNC(void, RediSearch_VectorFieldSetefConstruction)(RSIndex* sp, RSFieldID fs, size_t efConstruction);
MODULE_API_FUNC(void, RediSearch_VectorFieldSetefRuntime)(RSIndex* sp, RSFieldID fs, size_t efRuntime);
